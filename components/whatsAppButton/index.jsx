  ...
  return (
    <div className='  '>
      <Tooltip
        ...
        <button className='rounded-full w-fit text-white bg-green-500 motion-safe:animate-bounce " focus:animate-none hover:animate-none  text-md  p-2  tracking-wide '>
